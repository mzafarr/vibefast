    ...
    <footer className="bg-muted/50 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 py-12">
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              The fastest way to build and ship React Native apps with AI integration. Complete boilerplate with mobile
              app, landing page, and backend.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li>
                <a href="mailto:support@vibefast.com" className="hover:text-primary transition-colors">
                  Contact
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">© 2024 VibeFast. All rights reserved.</p>
