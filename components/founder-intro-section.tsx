            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  I'm a full-stack web & app developer, indie builder, and
                  creator of VibeFast. Over the past 3 years, I've worked with
                  clients across the world on everything from AI tools to
                  internal dashboards and mobile apps, earning thousands of
                  dollars delivering real-world software.
                </p>

                <p className="text-muted-foreground leading-relaxed">
                  While freelancing, I kept seeing the same thing: devs —
                  especially beginners — stuck in the weeds setting up
                  boilerplate, or worse, hallucinating code with LLMs that
                  didn't work. So I built VibeFast.
                </p>

                <p className="text-muted-foreground leading-relaxed">
                  It's the starter I wish I had — fast, production-ready, and
                  actually designed for{" "}
                  <span className="font-semibold text-primary">
                    vibe coding
                  </span>{" "}
                  (coding with AI). I also make videos sharing my journey and
                  learnings in building, shipping, marketing apps and SaaS with
                  this very stack.
                </p>

                <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
                  <p className="text-foreground font-semibold">
                    And I mean it when I say it, VibeFast is your shortcut to
                    real results.
                  </p>
                </div>
              </div>
              ...
              <div className="pt-4 space-y-2">
                <p className="text-muted-foreground">
                  I share my journey building and shipping apps on social media,
                  and help developers like you skip the setup headaches and
                  focus on what matters — building profitable products.
                </p>
              </div>
            </div>
